...
const WeatherApp = () => {
        ...
        let api_key = "65c26cd39e92f112d0c436a2d30f3951";
    ...
    return (
        <div className='container'>
            ...
            <div className="weather-temp">42.71°F</div>
            <div className="weather-location">London</div>
            <div className="data-container">
                <div className="element">
                    <img src={humidity_icon} alt="" className="icon" />
                    <div className="data">
                        <div className="humidity-percent">87%</div>
                ...
                <div className="element">
                    ...
                    <div className="data">
                        <div className="wind-rate">8.05 mph</div>
